...
test.describe('Parcours 5 — mobile 390 × 844 et clavier', () => {
  test('sélectionner une preuve, déplacer le temps, ajouter une hypothèse, lire une contradiction, confronter, sauvegarder', async ({ page }) => {
    ...
    await placeClaim(page, 'Interruption vidéo', 'Débranchement volontaire', { actor: 'Malik Bensaïd — Caissier' });
    ...
    // Confronter
    await confront(page, 'Malik Bensaïd', /pochette directement sur son bureau/, 'Journal vidéo', 'neutre');
