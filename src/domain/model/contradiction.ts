...
export type ExplanationStep =
  ...
  | {
      ...
      zoneId: ZoneId;
      interval: Interval;
      source: 'camera' | 'evidence' | 'fact' | 'statement' | 'claim';
    }
  ...
  | {
      type: 'overlap';
      characterId: CharacterId;
      a: { zoneId: ZoneId; interval: Interval };
      b: { zoneId: ZoneId; interval: Interval };
    }
  | {
      type: 'sight';
  ...
  | {
      type: 'proposition-conflict';
      a: string;
      b: string;
      reason: 'explicit' | 'space-time' | 'same-slot';
    }
  | {
      type: 'knowledge-gap';
      characterId: CharacterId;
